...
RSpec.shared_context 'items repo' do
  ...
  let(:items_repo) { Agave::Local::ItemsRepo.new(entities_repo) }
  let(:entities_repo) { Agave::Local::EntitiesRepo.new(payload) }
  let(:payload) do
    {
      data: [
        {
        ...
        },
        {
          ...
          attributes: {
            ...
            theme_hue: 190,
            domain: nil,
            internal_domain: 'wispy-sun-3056.admin.agavecms.com',
            global_seo: global_seo,
            favicon: favicon,
            no_index: no_index,
            ssg: nil,
            image_host: 'www.agavecms-assets.com'
          },
          relationships: {
            menu_items: {
              data: [
