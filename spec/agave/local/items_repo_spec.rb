  ...
  module Local
    RSpec.describe ItemsRepo do
      ...
      let(:entities_repo) do
        instance_double('Agave::Local::EntitiesRepo')
      end
      let(:item_type) do
        double(
          'Agave::Local::JsonApiEntity',
          api_key: 'post',
          singleton: false,
          modular_block: false,
          sortable: false,
      ...
      let(:item_entity) do
        double('Agave::Local::JsonApiEntity', item_type: item_type)
      end
      let(:item_2_entity) do
        double('Agave::Local::JsonApiEntity', item_type: item_type)
      end
      let(:singleton_item_entity) do
        double('Agave::Local::JsonApiEntity', item_type: singleton_item_type)
      end
      let(:item) do
        instance_double('Agave::Local::Item', id: '14')
      end
      let(:item_2) do
        instance_double('Agave::Local::Item', id: '15', position: 1)
      end
      let(:singleton_item) do
        instance_double('Agave::Local::Item', id: '22')
      end
      ...
      describe 'item_types' do
        ...
        describe 'sortable collection' do
          ...
          let(:item) do
            instance_double('Agave::Local::Item', id: '14', position: 2)
          end
          let(:item_2) do
            instance_double('Agave::Local::Item', id: '15', position: 1)
          end
      ...
      describe ItemsRepo::ItemCollection do
        ...
        let(:foo) { double('Agave::Local::Item', id: '1', name: 'Foo') }
